...
class LeftFrame(ttk.Frame):
    ...
    def create_sections(self):
        ...
        for i in range(1, 6):
            ...
            section_frame.grid_rowconfigure(0, weight=1)  # Ensure the row expands to fill the available vertical space
    ...
    def create_label_and_text_area(self, section_frame, label_text):
        ...
        text_area = tk.Text(section_frame, height=3, width=20, font=TEXT_AREA_FONT, wrap=tk.WORD)
        text_area.grid(row=0, column=1, padx=5, pady=5, sticky="ns ew")
