...
def create_label_and_buttons(parent, image_handler, open_color_wheel_window, open_search_window):
    ...
    label_text_1 = "BG Color:"
    background_label = ttk.Label(parent, text=label_text_1, font=LABEL_FONT, width=10, anchor="center")
    ...
    color_wheel_button = ttk.Button(button_frame_1, text="Color Wheel", style="Small.TButton", width=12, command=open_color_wheel_window)
    color_wheel_button.pack(side="left", padx=5)

    gradient_button = ttk.Button(button_frame_1, text="Gradient", style="Small.TButton", width=12, command=lambda: open_color_wheel_window(gradient=True))
    ...
    label_text_2 = "Image 1" + (" ✓:" if image1_selected else " :")
    label = ttk.Label(parent, text=label_text_2, font=LABEL_FONT, width=10, anchor="center")
    ...
    browse_button_1 = ttk.Button(button_frame_2, text="Browse", style="Small.TButton", width=8, 
                                 command=lambda: image_handler.browse_image('image1'))
    browse_button_1.pack(side="left", padx=5)

    search_button_1 = ttk.Button(button_frame_2, text="Search", style="Small.TButton", width=8, 
                                 command=lambda: open_search_window('image1'))
    search_button_1.pack(side="left", padx=5)
    
    remove_button_1 = ttk.Button(button_frame_2, text="Remove", style="Small.TButton", width=8, 
                                 command=lambda: image_handler.remove_image('image1'))
    remove_button_1.pack(side="left", padx=5)

    # Label for second image
    label_text_3 = "Image 2" + (" ✓:" if image2_selected else " :")
    second_image_label = ttk.Label(parent, text=label_text_3, font=LABEL_FONT, width=10, anchor="center")
    ...
    browse_button_2 = ttk.Button(button_frame_3, text="Browse", style="Small.TButton", width=8, 
                                 command=lambda: image_handler.browse_image('image2'))
    browse_button_2.pack(side="left", padx=5)

    search_button_2 = ttk.Button(button_frame_3, text="Search", style="Small.TButton", width=8, 
                                 command=lambda: open_search_window('image2'))
    search_button_2.pack(side="left", padx=5)
    
    remove_button_2 = ttk.Button(button_frame_3, text="Remove", style="Small.TButton", width=8, 
