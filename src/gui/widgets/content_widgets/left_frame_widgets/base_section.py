...
class BaseSection(ttk.Frame):
    def __init__(self, parent, label_text, data_handler=None, flyer_manipulator=None, show_align_buttons=True, show_font_dropdown=True, show_font_size_dropdown=True):
        """
        ...
        flyer_manipulator : object, optional
            The flyer manipulator object.
    ...
    def create_section(self):
        ...
        self.text_tool_bar = TextToolBar(self, self.data_handler, self.flyer_manipulator, show_align_buttons=self.show_align_buttons, show_font_dropdown=self.show_font_dropdown, show_font_size_dropdown=self.show_font_size_dropdown)
